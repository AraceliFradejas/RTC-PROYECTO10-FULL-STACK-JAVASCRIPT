...
const events = [
  ['The Next Inch: Leadership', '2027-02-18T18:00:00.000Z', 'Madrid · Espacio KelseTS', 'Liderazgo', '/images/events/event-leadership.webp', 'Alison Patrick convierte la presión del último cuarto en una conversación práctica sobre decisiones, responsabilidad y liderazgo compartido. Saldrás con una jugada concreta para activar con tu equipo.', 180],
  ['The Comeback Mindset', '2027-03-11T18:30:00.000Z', 'Barcelona · Impact Hub', 'Resiliencia', '/images/events/event-comeback.webp', 'Travis Wood explora cómo volver después de un tropiezo sin ignorar lo aprendido. Una experiencia sobre recuperación, constancia y el valor de avanzar paso a paso.', 140],
  ['One Team, One Play', '2027-04-08T17:30:00.000Z', 'Valencia · La Marina', 'Equipo', '/images/events/event-teamwork.webp', 'Jude Becks propone dinámicas para transformar un grupo de talento individual en un equipo que comparte contexto, confianza y una dirección clara.', 200],
  ...
  ['The Last Quarter', '2027-06-17T18:30:00.000Z', 'Sevilla · Cartuja Center', 'Rendimiento', '/images/events/event-last-quarter-portrait-v4.jpg', 'Cuando el tiempo aprieta, cada decisión importa. Esta experiencia trabaja prioridades, comunicación y energía colectiva para cerrar proyectos exigentes.', 240],
  ...
  ['Innovate the Playbook', '2027-10-21T17:30:00.000Z', 'Madrid · KelseTS Business School', 'Innovación', '/images/events/event-innovation.webp', 'Anna Nasser conecta estrategia deportiva e innovación para ayudar a los equipos a cuestionar su plan sin perder su propósito.', 150],
