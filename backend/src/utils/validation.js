...
export const validateCredentials = (body = {}, registration = false) => {
  ...
  if (registration && (password.length < 8 || Buffer.byteLength(password, 'utf8') > 72)) throw new AppError('La contraseña debe tener al menos 8 caracteres y ocupar como máximo 72 bytes.', 400);
