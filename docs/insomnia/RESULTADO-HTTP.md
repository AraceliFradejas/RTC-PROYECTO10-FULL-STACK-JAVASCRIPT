...
Actualización del 13 de septiembre: Ejecuté posteriormente la colección en Insomnia 13.2.0. Se revisaron las 28 capturas: 28 resultados esperados, incluida la repetición del avatar con archivo real y URL Cloudinary. Ver la [validación detallada](VALIDACION-DETALLADA.md). Los datos temporales de esta segunda ejecución son distintos; las dos cuentas permanecen y su evento fue eliminado.
