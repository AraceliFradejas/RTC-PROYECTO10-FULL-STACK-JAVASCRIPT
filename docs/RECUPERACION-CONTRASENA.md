...
- La titular confirma el recorrido manual en la web publicada: recuperación mediante el mensaje de Mailtrap, cambio de contraseña e inicio de sesión posterior satisfactorio. Confirmación comunicada en la sesión de trabajo del 19/09/2026; no se han guardado contraseña, token ni captura de ese recorrido.
