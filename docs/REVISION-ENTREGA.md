...
| Subida de ficheros | Cartel y avatar probados mediante API con Cloudinary; creación desde la web confirmada. |
...
Implementados solicitud y cambio de contraseña con Mailtrap Sandbox, ES/EN, enlaces temporales de un solo uso y revocación de sesiones. Pruebas ordinarias: 73 correctas; integración real de recuperación en Atlas: correcta. [Configuración y paso a correo real](RECUPERACION-CONTRASENA.md). Despliegue y comprobaciones HTTP correctos. He recuperado mi contraseña mediante Mailtrap e iniciado sesión en la web publicada. Quedan separados de esta validación los recorridos de reserva/cancelación y edición de eventos.


### Reserva y cancelación públicas — 19/09/2026

Reserva observada en Chrome: mi nombre aparece en participantes y se muestra el aviso de plaza confirmada. Confirmo los correos de reserva y cancelación en Mailtrap y, al cancelar desde la web, asistencia desmarcada, aumento de plazas disponibles y mensaje de cancelación. Recorrido cerrado, sin nuevas capturas guardadas. Continúan pendientes la creación/edición de eventos y subida de ficheros en producción, además del paquete final de entrega.

### Edición en la interfaz — 19/09/2026

Creación de «Tu mente y la presión» para el 15/03/2027 confirmada. Se detectó y corrigió la ausencia de edición en el frontend; la API ya la permitía. Añadidos botón y formulario protegido ES/EN, conservando cartel y fecha sin modificar. 52 pruebas frontend y build correctos. Corrección publicada en `f249d31`. Confirmo el cambio de texto y hora; se observa «Cambios guardados» y una consulta independiente a la API verifica descripción y fecha persistidas, Travis Wood y URL del cartel. No se ha probado sustituir el cartel durante una edición.
