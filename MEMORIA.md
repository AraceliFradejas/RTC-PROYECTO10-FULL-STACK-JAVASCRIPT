...
Validación: 73 pruebas ordinarias correctas y una integración adicional de recuperación en una base temporal real de Atlas, con dos cambios concurrentes y revocación de sesión. Build y verificación de 14 documentos HTML correctos. La prueba automatizada de integración no envía correo. El recorrido de la titular en Vercel y Mailtrap se realiza después del despliegue; no se incluyen enlaces de recuperación, contraseñas ni secretos en las evidencias.
