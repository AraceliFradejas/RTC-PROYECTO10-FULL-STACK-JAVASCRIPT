...
export const EventsPage = () => {
  ...
  return <section className="page shell">
    <div className="page-heading"><p className="kicker">KelseTS Experiences</p><h1>Tu próxima idea puede cambiar el <em>partido.</em></h1><p>Keynotes, conversaciones y sesiones prácticas para crecer como profesional y como equipo.</p></div>
    <div className="filters">
      <label className="search-field"><Search /><span className="sr-only">Buscar eventos</span><input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Busca por tema, speaker o lugar" /></label>
